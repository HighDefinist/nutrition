...
public:
  virtual bool Init(std::string WindowName, float scale, int x, int y, int xSz, int ySz) override {
    ...
    io.Fonts->AddFontFromFileTTF((std::string(PROJECT_SOURCE_DIR)+"/extra/Exo2-Medium.ttf").c_str(), 16.0f*scale);
